...
<section class="section-base bg-merabuAmber-50 h-fit snap-start items-center sm:h-screen">
	<div
		class="section-container max-w-screen w-full justify-start rounded-3xl bg-orange-100 p-4 pt-8" data-fade-children>
		...
		<div class="mt-8 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3" data-fade-children>
